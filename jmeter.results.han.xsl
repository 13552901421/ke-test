...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/testResults">
            ...
            <script type="text/javascript"><![CDATA[
                ...
                var onclick_li = (function() {
                    ...
                    return function(li) {
                        ...
                        patch_compareResult(document.getElementById("right-panel"));
                        return false;
                    };
                })();
        ...
        var changeDiff = function(str,arr,substr) {
            let strarr = arr;
            let sub = substr;
            let fromindex = 0;
        ...
        var compareSequence = function(source, target) {
            let matrix = [];
            let n = source.length;
            let m = target.length;
            //初始化第一列
        ...
        var getMaxSubstring = function(arr, source, target, i, j) {
           if (i == 0 || j == 0) {
                return;
            }
		...
		var patch_compareResult = function(doc) {
		    var failMsg1 = doc.getElementsByClassName("failMsg1");
		    var failMsg2 = doc.getElementsByClassName("failMsg2");
            var succMsg1 = doc.getElementsByClassName("succMsg1");
            var succMsg2 = doc.getElementsByClassName("succMsg2");
		    var len = failMsg1.length;
            for (var i = 0; i < len; ++i) {
                var fmsg1 = failMsg1[i];
                var fmsg2 = failMsg2[i];
                var smsg1 = succMsg1[i];
                var smsg2 = succMsg2[i];
                var expectedStr = fmsg1.innerHTML.trim().slice(39,-1).trim();
                var responseStr = smsg1.innerHTML;
                if (expectedStr != '') {
                    let changeStr = compare(expectedStr,responseStr);
                    fmsg2.innerHTML = changeStr[0];
                    smsg2.innerHTML = changeStr[1];
                }
            }
		};
                            ...
                            <div>
                                        ...
                                        <table>
                                            <xsl:for-each select="assertionResult">
                                                <tbody>
                                                    ...
                                                    <tr><td class="data key">Failure Message</td><td class="data delimiter">:</td><td class="data failMsg1"><xsl:value-of select="failureMessage"/></td></tr>
                                                </tbody>
                                            </xsl:for-each>
                                        </table>
                                    </div>
                                ...
                                <div class="zebra">
                                    <table>
                                        ...
                                        <tr><td class="data key">Response Data</td><td class="data delimiter">:</td><td class="data"><pre class="data succMsg1"><xsl:value-of select="responseData"/></pre></td></tr>
                                ...
                                <div class="trail"></div>
                                <div class="group">对比</div>
                                <div class="zebra">
                                  <table>
                                    <tr>
                                      <td class="data key">预期断言</td>
                                      <td class="data delimiter">:</td>
                                      <td class="data"><pre class="data failMsg2" style="color:red"></pre></td>
                                    </tr>
                                    <tr>
                                      <td class="data key">实际结果</td>
                                      <td class="data delimiter">:</td>
                                      <td class="data"><pre class="data succMsg2"></pre></td>
                                    </tr>
                                  </table>
                                </div>
                                <div class="trail"></div>
